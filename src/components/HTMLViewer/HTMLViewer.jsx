...
const HTMLViewer = ({ isOpen, close, exportedHTML, exportedJSON }) => {
  return (
    <div className={`htmlv ${isOpen ? "htmlv--open" : ""}`}>
      <div className="htmlv__inner">
        ...
        <div className="htmlv__preview-panes-container">
          <div className="htmlv__preview-pane">
            <div className="htmlv__preview-pane-tab">HTML</div>
            {/* Code Preview */}
            <textarea
            ...
            <CopyButton toCopy={exportedHTML} />
          </div>

          <div className="htmlv__preview-pane">
            <div className="htmlv__preview-pane-tab">JSON</div>
            {/* Code Preview */}
            <textarea
              className="htmlv__textarea"
              readOnly
              value={
                JSON.stringify(exportedJSON) || "Nothing to see here yet..."
              }
            ></textarea>

            <CopyButton toCopy={JSON.stringify(exportedJSON)} />
          </div>
        </div>
      </div>
    </div>
